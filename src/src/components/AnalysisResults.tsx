...
export function AnalysisResults({ handLength, analysis }: Props) {
  return <section className="panel results-panel">
    <div className="panel-heading compact"><div><span className="step">02</span><div><h2>解析結果</h2></div></div><span className="calculating"><i />{handLength === 14 ? '計算済み' : '待機中'}</span></div>

...
export function HandEditor({ hand, discardsBySeat, meldsBySeat, riichiBySeat, analysisHandLength, shanten, waits, historyLength, onRemove, onRemoveDiscard, onRemoveMeldTile, onUndo, onReset }: Props) {

...
export function HandEditor({ hand, discardsBySeat, meldsBySeat, riichiBySeat, analysisHandLength, shanten, waits, historyLength, sampleMode, browserStatus, onRemove, onRemoveDiscard, onRemoveMeldTile, onUndo, onReset, onToggleSample, onConnect }: Props) {

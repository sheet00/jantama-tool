...
export function HandEditor({ hand, visible, shanten, counts, destination, historyLength, onAdd, onRemove, onRemoveVisible, onDestinationChange, onUndo, onReset }: Props) {
